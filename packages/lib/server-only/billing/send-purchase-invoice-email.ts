...
import { isResellerFeatureAllowedEmail } from '../../constants/esign-credit-packages';
...
export const sendPurchaseInvoiceEmail = async ({
  ...
  // Temporary: only send purchase invoices to the allowlisted emails.
  if (!isResellerFeatureAllowedEmail(toEmail)) {
