        ...
        <Section className="bg-white text-slate-700">
          <Container className="mx-auto my-0 max-w-xl px-4 py-6">
            {branding.brandingEnabled && branding.brandingLogo ? (
              <Img src={branding.brandingLogo} alt="Nomia" className="mb-6 h-14" />
            ) : (
              <TemplateImage
            ...
            <div
              className="text-sm leading-6 text-slate-700 [&_a]:text-blue-600 [&_h1]:mb-3 [&_h1]:mt-0 [&_h1]:text-lg [&_h1]:font-semibold [&_h1]:text-slate-900 [&_h2]:mb-2 [&_h2]:mt-4 [&_h2]:text-base [&_h2]:font-semibold [&_h2]:text-slate-900 [&_li]:mb-1 [&_ol]:my-3 [&_ol]:pl-5 [&_p]:my-3 [&_ul]:my-3 [&_ul]:pl-5"
