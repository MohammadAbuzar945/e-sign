    ...
    <>
      ...
      <Section className="flex-row items-center justify-center">
        <Text className="mx-auto mb-0 max-w-[80%] text-center font-semibold text-lg text-primary">
          <Trans>Welcome to Nomia!</Trans>
        </Text>

        <Text className="my-1 text-center text-base text-slate-400">
          <Trans>An administrator has created a Nomia account for you.</Trans>
        </Text>
        ...
        <Section className="mt-8">
          <Text className="text-center text-slate-400 text-sm">
            <Trans>
              ...
              <Link href="mailto:help@nomiadocs.com" className="text-documenso-500">
                contact support
              </Link>
              .
            </Trans>
