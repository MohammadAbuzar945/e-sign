...
export const EnvelopeEditorFieldsPageRenderer = ({ pageData }: { pageData: PageRenderData }) => {
  ...
  useEffect(() => {
    ...
    pageLayer.current.batchDraw();
  }, [localPageFields, selectedKonvaFieldGroups, selectedKonvaFieldGroups]);
...
const FieldActionButtons = ({
  ...
  const preselectedRecipient = useMemo(() => {
    ...
    return null;
  }, [editorFields.localFields, envelope.recipients, selectedFieldFormId, envelope.recipients, selectedFieldFormId]);
