  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using Nomia to perform your electronic document signing. The purpose of this disclosure is to
        ...
        <p>
          <Trans>
            ...
            the Electronic Communications and Transactions Act and other applicable laws. This action indicates your
            agreement to use electronic means to sign documents and receive notifications.
          </Trans>
        </p>
        ...
        <p>
          <Trans>
            ...
            the sender you may reach out to <a href="mailto:help@nomiadocs.com">help@nomiadocs.com</a> for assistance.
            Be aware that withdrawing consent may delay or halt the completion of the related transaction or service.
          </Trans>
        </p>
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by Nomia, you affirm that you have read and
        ...
        <p>
          <Trans>
            ...
            us at: <a href="mailto:help@nomiadocs.com">help@nomiadocs.com</a>
          </Trans>
        </p>
      </article>
