...
export default function TemplatePage({ params }: Route.ComponentProps) {
  ...
  const templatesListPath = formatTemplatesPath(team.url, envelope.folderId);
  ...
  return (
    <div className="mx-auto -mt-4 w-full max-w-screen-xl px-4 md:px-8">
      <Link to={templatesListPath} className="flex items-center text-documenso-700 hover:opacity-80">
              ...
              <div className="flex flex-row items-center justify-between px-4">
                ...
                <div>
                  <TemplatesTableActionDropdown
                    ...
                    onDelete={async () => navigate(templatesListPath)}
                  />
                </div>
              </div>
